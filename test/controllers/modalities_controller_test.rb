...
class ModalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modality" do
    assert_difference("Modality.count") do
      post modalities_url, params: { modality: { description: @modality.description, name: @modality.name } }
    end
  ...
  test "should update modality" do
    patch modality_url(@modality), params: { modality: { description: @modality.description, name: @modality.name } }
