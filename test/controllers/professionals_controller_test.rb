...
class ProfessionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professional" do
    assert_difference("Professional.count") do
      post professionals_url, params: { professional: { email: @professional.email, name: @professional.name, phone: @professional.phone } }
    end
  ...
  test "should update professional" do
    patch professional_url(@professional), params: { professional: { email: @professional.email, name: @professional.name, phone: @professional.phone } }
